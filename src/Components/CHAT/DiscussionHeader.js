    ...
    <View style={styles.header}>
      ...
      <View style={styles.header_container_right}> 
        ...
        <View style={styles.title_container}>
          <Text style={styles.title} numberOfLines={1}>lol{/* props.title */}</Text>
        </View>
        <View style={styles.comment_container_left}>            
            <BounceUpAndDownStatic
              scale={.8}
              onPress={() => {
                props.navigateTo('ImageViewerDynamic', {
                  //title: props.title,
                  //imgURLPreview: imageResizer(props.pic, USER_IMG_SIZE),                
                })
              }}
            >
              <View style={styles.comment_container_left_img_container}>
                {'group' === 'group'//props.type === 'group'
                  ? <View style={{flex:1}}>
                      <Image
                      ...
                      {/*<Image
                        ...
                        source={{ uri: imageResizer(props.pic, USER_IMG_SIZE) }}
                      />*/}
                    </View>
                  : <View style={{flex:1}}>
                      <Image
